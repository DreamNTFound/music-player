...
export default function MusicLibrary() {
  const { libraryItems, setIsCreatePLModalOpen } = useOutletContext();
    ...
    <>
      <div className="p-4">
        <div className="flex items-center justify-between p-4 border-b border-gray-800">
          ...
          <button onClick={() => setIsCreatePLModalOpen(true)} className="md:hidden flex items-center gap-3 !px-3 !py-2 rounded-md transition text-white !bg-gray-800/70 hover:!bg-purple-700/30 hover:scale-105">Create Playlist</button>
        </div>
